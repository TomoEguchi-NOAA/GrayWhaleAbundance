...
YEAR <- 2026 #10 #Enter the year of the data files

save.output <- T #F #TRUE
...
out.dir <- paste0("RData/V2.1_Feb", YEAR)
...
grace_min <- 30 #60 # 80#5 #       # this makes it minimum of shift_dur_min - grace_min
...
# 2026-02-18
# Warning in left_join(., Effort4Laake_1 %>% dplyr::select(key, pphr), by = "key") :
...
#   warning.
#
# This problem was from differences in observers (defined with a "P" option) and actual
# sighting observers. Data files were corrected to match sighting observers to those
# who were defined with a "P" option. 
if (YEAR == 2023){
