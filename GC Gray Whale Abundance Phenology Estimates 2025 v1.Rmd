...
data.first. <- yrs.summary[[length(years.to.summarize)]]$data.first.
data.last.  <- yrs.summary[[length(years.to.summarize)]]$data.last.
...
Because the N-mixture modeling approach uses all data since the 2006/2007 season to estimate parameters that are shared among yearly datasets, estimated abundances change as more data are added to the analysis. In the past, we only provided the new estimate and kept the estimates for previous years as they were provided in the reports. In this report, we provide only updated estimates. For old estimates, please see Eguchi et al. (2024). 
...
# This was already done above. whale.groups.daily.df - compare them with 
# the code here. 
