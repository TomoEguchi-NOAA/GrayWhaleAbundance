...
N.hats.new <- read_csv(file = "Data/WinBUGS_abundance_2007to2025_v2_min85_100000_2025-02-25.csv",
...
years.summarize <- c(2015, 2016, 2020, 2022, 2023, 2024, 2025)
...
yrs.summary <- lapply(years.summarize, FUN = summary.season)

data.first. <- yrs.summary[[length(years.summarize)]]$data.first.
data.last.  <- yrs.summary[[length(years.summarize)]]$data.last.

whale.groups.daily.list <- lapply(yrs.summary, FUN = function(x) x$whale.groups.daily)
...
# Find daily data:
data.new <- readRDS(file = "RData/V2.1_Feb2025/out_2025_min85_Tomo_v2.rds")
...
WinBUGS.results <- readRDS(paste0("RData/WinBUGS_2007to2025_v2_min85_100000_2025-02-25.rds"))
