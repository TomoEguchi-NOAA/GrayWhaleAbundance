...
# segmented regression for one less year
lm.2 <- lm(median.idx ~ Year, data = median.idx.one.less)
...
flextable(all.estimates.new %>% dplyr::select(-Year)) %>% 
