...
I have also ran the model with n.iter = 1000000. Every once in a while, errors were returned when running this many steps. The reason for it was unknown. I have never had any problems with n.iter = 85000.
...
The markdown file uses the Marine Ecology Progress Series style references. In order for this to work, you will have to have a "csl" (Citation Style Language) file specifying the style. This can be 
